...
export const availability = {
  ...
  "glm-4.6v-flash": {
    "huggingface": { id: "zai-org/GLM-4.6V-Flash", narrows: { drops: ["video"] } },
  ...
  "glm-5.3-flashx": {
    "openrouter": { id: "z-ai/glm-5.3-flashx", narrows: { drops: ["pdf"] } },
    "vercel": { id: "zai/glm-5.3-flashx", narrows: { drops: ["video", "pdf"] } },
