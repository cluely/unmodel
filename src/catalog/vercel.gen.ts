...
export const models = {
  ...
  "zai/glm-5.3": {
    ...
    modalities: { input: ["text"], output: ["text"] },
    limit: { context: 1000000, output: 1000000 },
    cost: { input: 0.7, output: 2.2, cacheRead: 0.13 },
  },
  "zai/glm-5.3-fast": {
    id: "zai/glm-5.3-fast",
    name: "GLM 5.3 Fast",
