 ...
 * - Same route-is-the-model shape as flux2()/fluxKontext(): `model` is a
...
import { flux1Constraints } from "./constraints";
...
const validator = createValidator<Flux1Body, unknown>({
  endpoint: "black-forest-labs.flux1",
  schema: flux1Schema,
  modelId: (params) => params.model,
  catalog: models,
  constraints: flux1Constraints,
 ...
 *
 * ```ts
 * const params = blackForestLabs.flux1({
 *   model: "flux-pro-1.1",
 ...
 * ```
 */
export const flux1 = validator as unknown as {
