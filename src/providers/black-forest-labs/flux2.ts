 ...
 *   interpolates it into `.request.url`. One `flux2()` endpoint fn covers the
 ...
 *   multiple-of-32 and 256–1440; see flux1.ts.)
...
import { flux2Constraints } from "./constraints";
...
const validator = createValidator<Flux2Body, unknown>({
  endpoint: "black-forest-labs.flux2",
  schema: flux2Schema,
  modelId: (params) => params.model,
  catalog: models,
  constraints: flux2Constraints,
  estimate,
  finalize,
});
 ...
 *
 * ```ts
 * const params = blackForestLabs.flux2({
 *   model: "flux-2-pro",
 ...
 * ```
 */
export const flux2 = validator as unknown as {
