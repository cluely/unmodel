 ...
 *
 * Same body as `image` minus `resolution`, `negative_prompt` and
 * `steps_num`, at $0.02 instead of $0.03 per image.
 *
 * ```ts
 * const params = bria.imageLite({ prompt: "a ring on a marble table" });
 * ```
 */
