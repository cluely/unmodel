...
const contentGenerationTasksSchema = z.looseObject({
  model: z.string(),
...
const validator = createValidator<ContentGenerationTasksBody, unknown>({
  endpoint: "bytedance.contentGenerationTasks",
  schema: contentGenerationTasksSchema,
  modelId: (params) => params.model,
  catalog: videoModels,
  constraints: contentGenerationTasksConstraints,
 ...
 *
 * ```ts
 * const params = bytedance.contentGenerationTasks({
 *   model: "seedance-1-5-pro-251215",
 ...
 * ```
 */
export const contentGenerationTasks = validator as unknown as {
