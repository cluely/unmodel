...
/**
 * SDK targets for `cartesia.transcribe`. `@cartesia/cartesia-js` takes wire-shaped
 ...
 *
 * ```ts
 * const params = cartesia.transcribe({ file, model: "ink-whisper" });
