 ...
 *
 * ```ts
 * const params = elevenlabs.speechToText({ model_id: "scribe_v2", file: blob });
...
/**
 * SDK targets for `elevenlabs.speechToText`. `"elevenlabs"` camelCases the
...
const validator = createValidator<SpeechToTextParams, unknown>({
  endpoint: "elevenlabs.speechToText",
 ...
 */
export const speechToText = validator as unknown as {
