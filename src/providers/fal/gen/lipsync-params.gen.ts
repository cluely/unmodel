...
export const FAL_LIPSYNC_MODELS = ["fal-ai/kling-video/lipsync/audio-to-video", "fal-ai/latentsync", "fal-ai/pixverse/lipsync", "fal-ai/sync-lipsync/v2", "fal-ai/sync-lipsync/v2/pro", "fal-ai/sync-lipsync/v3", "veed/lipsync", "veed/lipsync/v2"] as const;
