...
export const falLipsyncInputSchema = z.looseObject({
   ...
   * details (fal-ai/heygen/v3/lipsync/precision, fal-ai/heygen/v3/lipsync/speed,
   * fal-ai/kling-video/lipsync/audio-to-video, fal-ai/latentsync, fal-ai/pixverse/lipsync,
   * fal-ai/sync-lipsync/v2, fal-ai/sync-lipsync/v2/pro, fal-ai/sync-lipsync/v3,
   * veed/lipsync, veed/lipsync/v2), so the union takes the bare type and the exact
   * vocabulary is enforced per endpoint from FAL_LIPSYNC_SHAPES.
   */
