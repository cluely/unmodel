...
import { transcribe as validator, type PreRecordedBody } from "./transcribe";
...
} as const satisfies TranscribeAdapterFor<"url", GladiaTranscribeWire, GladiaTranscribeResult>;
