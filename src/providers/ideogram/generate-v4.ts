...
import { RENDERING_SPEEDS, type IdeogramRenderingSpeed } from "./generate";
 ...
 *
 * ```ts
 * const params = ideogram.generateV4({
 ...
 * ```
 */
export const generateV4 = validator as unknown as {
