 ...
 *   (text_prompt/json_prompt, ResolutionV4) — see `generateV4` in
 *   generate-v4.ts. The 3.0 editing routes (edit/remix/reframe/
 ...
 *
 * ```ts
 * const params = ideogram.generate({ prompt: "a cat", rendering_speed: "TURBO" });
 ...
 */
export const generate = validator as unknown as {
