...
// Re-exported for compatibility: the helper moved to its own leaf so the
// voice-creation packs can size a base64 payload without this validator.
export { decodedBase64Bytes } from "./audio-bytes";
