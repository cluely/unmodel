 ...
 *
 * Exported as `kling.imageToVideoV3`. "V3" names the third-generation ROUTE
 ...
 * `kling.imageToVideo` (./image2video.ts) unless you have verified this
...
const imageToVideoV3Schema = z.looseObject({
...
const validator = createValidator<ImageToVideoV3Params, unknown>({
  endpoint: "kling.imageToVideoV3",
  schema: imageToVideoV3Schema,
 ...
 * `kling.imageToVideo` is the corroborated image-to-video validator.
 *
 * ```ts
 * const params = kling.imageToVideoV3({
 *   model: "kling-2.6",
 *   contents: [
 ...
 * ```
 */
export const imageToVideoV3 = validator as unknown as {
