 ...
 *
 * Exported as `kling.omniVideo`, a sibling of `kling.textToVideoV3` /
 * `kling.imageToVideoV3`. It has no corroborated counterpart: the
 ...
 * `kling.textToVideo` (./text2video.ts) unless you have verified this
...
const omniVideoSchema = z.looseObject({
...
const validator = createValidator<OmniVideoParams, unknown>({
  endpoint: "kling.omniVideo",
  schema: omniVideoSchema,
 ...
 * ```
 */
export const omniVideo = validator as unknown as {
