 ...
 *
 * Exported as `kling.textToVideoV3`. "V3" names the third-generation ROUTE
 ...
 * `kling.textToVideo` (./text2video.ts) unless you have verified this route against a
...
const textToVideoV3Schema = z.looseObject({
...
const validator = createValidator<TextToVideoV3Params, unknown>({
  endpoint: "kling.textToVideoV3",
  schema: textToVideoV3Schema,
 ...
 *
 * EXPERIMENTAL and uncorroborated — see the module header. `kling.textToVideo`
 ...
 *
 * ```ts
 * const params = kling.textToVideoV3({
 *   model: "kling-3.0",
 ...
 * ```
 */
export const textToVideoV3 = validator as unknown as {
