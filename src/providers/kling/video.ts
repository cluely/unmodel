 ...
 *
 * Exported as `kling.video`: the PRIMARY text-to-video validator.
 *
 ...
 *   corroborate it — it ships as the EXPERIMENTAL `kling.videoV3` (see
 *   ./video-v3.ts), and its id spellings differ (`kling-3.0` there vs
 *   `kling-v3` here).
