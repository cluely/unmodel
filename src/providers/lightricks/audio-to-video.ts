...
const audioToVideoSchema = z.looseObject({
  audio_uri: uriSchema,
...
const validator = createValidator<AudioToVideoParams, unknown>({
  endpoint: "lightricks.audioToVideo",
  schema: audioToVideoSchema,
 ...
 *
 * ```ts
 * const params = lightricks.audioToVideo({
 ...
 * ```
 */
export const audioToVideo = validator as unknown as {
