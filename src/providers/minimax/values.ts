/**
 * `unmodel/minimax/values` — the **runtime** lists behind this provider's
 ...
 * `unmodel/minimax/types`, for the client-side validation and the pickers
 * a type cannot draw.
 *
...
export {
  MINIMAX_VIDEO_MODEL_PARAMS as VIDEO_MODEL_PARAMS,
