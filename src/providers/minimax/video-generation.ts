...
const videoGenerationSchema = z.looseObject({
...
const validator = createValidator<VideoGenerationParams, unknown>({
  endpoint: "minimax.videoGeneration",
 ...
 *
 * ```ts
 * const params = minimax.videoGeneration({
 ...
 * ```
 */
export const videoGeneration = validator as unknown as {
