...
import { transcribe as validator, type TranscriptionChunkingStrategy } from "./transcribe";
...
const OPENAI_TRANSCRIBE_MODEL_PARAMS = {
  "gpt-transcribe": {
    timestamps: ["none"],
...
export const transcribe = {
  ...
  provider: "openai",
  models: MODELS,
  modelParams: OPENAI_TRANSCRIBE_MODEL_PARAMS,
  audioInputs: ["file"],
  unsupported: {
    diarization:
  ...
  compile(
    ...
    applyExtras(input, OPENAI_TRANSCRIBE_MODEL_PARAMS, body, ctx);

    return { params: body, validate: validator.safe };
  },
} as const satisfies TranscribeAdapterFor<
  "file",
  typeof OPENAI_TRANSCRIBE_MODEL_PARAMS,
  OpenaiTranscribeWire,
  OpenaiTranscribeResult
>;
