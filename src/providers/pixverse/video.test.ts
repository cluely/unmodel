...
describe("pixverse.video happy path", () => {
...
describe("pixverse.video model rules", () => {
...
describe("pixverse.video cost estimation", () => {
  test("v6 bills per second by quality and audio", () => {
    const silent = video.safe({
      model: "v6",
      prompt: "hi",
      aspect_ratio: "16:9",
      quality: "720p",
...
describe("pixverse.videoFromImage", () => {
  ...
  test("v4.5 motion_mode picks the fast credit column", () => {
    const normal = videoFromImage.safe({
      model: "v4.5",
      img_id: 1,
      prompt: "hi",
      quality: "720p",
    ...
    const fast = videoFromImage.safe({
      model: "v4.5",
      img_id: 1,
      prompt: "hi",
      quality: "720p",
