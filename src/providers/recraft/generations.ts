...
import { generationsFamilyRules } from "./constraints";
...
const validator = createValidator<GenerationsParams, unknown>({
  ...
  catalog: models,
  familyRules: generationsFamilyRules,
  checks: [
    checkResponseFormat,
    checkSpecEnums,
 ...
 *
 * ```ts
 * const params = recraft.generations({
 ...
 * ```
 */
export const generations = validator as unknown as {
