/**
 * `unmodel/resemble/values` — the **runtime** lists behind this provider's
 * unified surface (tts).
 *
 ...
 * `unmodel/resemble/types`, for the client-side validation and the pickers
 * a type cannot draw.
 *
...
export {
  RESEMBLE_TTS_MODEL_PARAMS as TTS_MODEL_PARAMS,
