/**
 * `unmodel/revai/types` — every `revai` type, and nothing else.
 *
 ...
 *
 * ```ts
 * import type { SttBody } from "unmodel/revai/types";
 *
 * const body = {
 ...
 *
 * - the **wire names** (`JobsBody`, `RevaiSourceConfig`,
 *   `RevaiNotificationConfig`, …) — re-exported verbatim, because they are
 ...
 * table — stay on `unmodel/revai`, which tree-shakes to the few bytes a
 * URL constant costs.
 *
 * Endpoints:
 *
