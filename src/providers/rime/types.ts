/**
 * `unmodel/rime/types` — every `rime` type, and nothing else.
 *
 ...
 *
 * ```ts
 * import type { TtsBody } from "unmodel/rime/types";
 *
 * const body = {
 ...
 *
 * - the **wire names** (`RimeTtsBody`, `RimeTtsParams`) — re-exported
 ...
 * table — stay on `unmodel/rime`, which tree-shakes to the few bytes a
 * URL constant costs.
 *
 * Endpoints:
 *
...
import type { RimeTtsParams } from "./tts";
...
export type TtsBody = RimeTtsParams;
