...
/**
 * SDK targets for `soniox.transcriptions`. Soniox publishes no official JS SDK
...
const validator = createValidator<
  ...
  Validated<TranscriptionsBody, TranscriptionsSdkTargets<TranscriptionsBody>>
>({
  endpoint: "soniox.transcriptions",
  schema,
 ...
 */
export const transcriptions = validator as unknown as {
