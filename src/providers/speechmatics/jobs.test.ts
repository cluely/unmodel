...
describe("speechmatics.jobs happy path", () => {
...
describe("speechmatics.jobs shape rules", () => {
...
describe("speechmatics.jobs operating_point deprecation", () => {
...
describe("speechmatics.jobs melia-1 feature gates", () => {
  test('melia-1 requires language "multi"', () => {
    const auto = jobs.safe({
      type: "transcription",
...
describe("speechmatics.jobs media + cost", () => {
  ...
  test("throwing form raises UnmodelValidationError", () => {
    expect(() =>
      jobs({ type: "transcription", transcription_config: { language: "auto", model: "melia-1" } }),
