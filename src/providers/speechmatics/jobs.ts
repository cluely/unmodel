 ...
 *   bytes). What unmodel validates is the CONFIG — `jobs(config)` returns the
...
/**
 * SDK targets for `speechmatics.jobs`. Speechmatics publishes no official JS
