 ...
 *   bytes). What unmodel validates is the CONFIG — `stt(config)` returns the
...
/**
 * SDK targets for `speechmatics.stt`. Speechmatics publishes no official JS
