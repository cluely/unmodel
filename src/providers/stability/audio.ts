...
const textToAudioValidator = createValidator<StableAudioTextToAudioParams, unknown>({
  endpoint: "stability.stableAudioTextToAudio",
...
const audioToAudioValidator = createValidator<StableAudioAudioToAudioParams, unknown>({
  endpoint: "stability.stableAudioAudioToAudio",
...
const inpaintValidator = createValidator<StableAudioInpaintParams, unknown>({
  endpoint: "stability.stableAudioInpaint",
 ...
 *
 * ```ts
 * const params = stability.stableAudioTextToAudio({
 ...
 * ```
 */
export const stableAudioTextToAudio = textToAudioValidator as unknown as StableAudioValidator<
 ...
 * Multipart endpoint — see `stableAudioTextToAudio` for the fetch recipe.
 */
export const stableAudioAudioToAudio = audioToAudioValidator as unknown as StableAudioValidator<
 ...
 * `stableAudioTextToAudio` for the fetch recipe.
 */
export const stableAudioInpaint = inpaintValidator as unknown as StableAudioValidator<
