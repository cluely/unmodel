 ...
 *
 * ```ts
 * const params = stability.imageCore({ prompt: "a lighthouse at dawn" });
 ...
 */
export const image = ultraValidator as unknown as
 ...
 * 1.5 megapixels).
 *
 * Multipart endpoint — see `image` for the fetch recipe.
 */
export const imageCore = coreValidator as unknown as
 ...
 * `image` for the fetch recipe.
 */
export const imageSd3 = sd3Validator as unknown as
