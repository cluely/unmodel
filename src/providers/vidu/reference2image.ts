...
const reference2imageSchema = z.looseObject({
  model: z.string(),
...
const validator = createValidator<Reference2ImageParams, unknown>({
  endpoint: "vidu.reference2image",
  schema: reference2imageSchema,
 ...
 *
 * ```ts
 * const params = vidu.reference2image({
 *   model: "viduq2",
 ...
 * ```
 */
export const reference2image = validator as unknown as {
