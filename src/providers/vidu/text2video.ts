 ...
 */
export const text2videoConstraints = {
...
const validator = createValidator<Text2VideoParams, unknown>({
  endpoint: "vidu.text2video",
  schema: text2videoSchema,
  modelId: (params) => params.model,
  catalog: videoModels,
  constraints: text2videoConstraints,
 ...
 * ```
 */
export const text2video = validator as unknown as {
